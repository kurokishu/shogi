...
(function (root, factory) {
  ...
  var LIST = [
    ...
    /* オリジナル戦法。
       いきなり初手で飛車を振って三間飛車にする。角道を開ける前に振るので、
       相手は何の戦型か分からないまま応対することになる。
       先手は ▲7八飛、後手はその上下反転で △3二飛（7八は先手陣の升のため）。 */
    { id: 'kurotaki78', name: '黒滝流７八飛', note: '初手から飛車を振る三間飛車。角道を開ける前に振って形を隠す',
      castle: 'mino', moves: ['2h7h', '7g7f', '1g1f'] }
  ];
