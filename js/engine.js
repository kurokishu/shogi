...
(function (root, factory) {
  ...
  var V = [0, 100, 350, 420, 550, 600, 820, 980, 20000, 610, 560, 560, 610, 0, 1080, 1250,
    /* 特殊駒は1局1枚の切り札。取られると相手の持ち駒（桂・香・角・金）に戻るので、
       元の駒より高く見積もらないと「交換した方が得」と判断して自分から手放してしまう。 */
    /*16 騎士*/ 900, /*17 忍*/ 520, /*18 風車(飛)*/ 950, /*19 風車(角)*/ 950,
    /*20 弓兵(撃可)*/ 620, /*21 弓兵(要移動)*/ 560, /*22 転生兵*/ 780, 0,
